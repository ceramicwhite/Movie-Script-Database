...
docker run \ 
        -e USE_IMSDB=true \
        -e USE_DAILYSCRIPT=false \
        -e RUN_GET_SCRIPTS=true \
        -e RUN_GET_METADATA=true \
        -e TMDB_API_KEY=your_api_key_here your_image_name \
        -v ./scripts:/app/scripts \
        ceramicwhite/movie-script-database
```
